...
- `nd-tzi-3-6-controls.yaml` — бібліотека каталогу заходів захисту (reference controls).
  Родини: AC (147), AT (17), AU (69), CA (32), CM (66), CP (56), IA (70), IR (42), MA (30), MP (30), PE (59), PL (17), PM (37), PS (18), RA (25). URN: `urn:intuitem:risk:library:dsszzi-nd-tzi-3-6-controls`.
